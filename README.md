...
| `NEXT_PUBLIC_SUPABASE_ANON_KEY` | Supabase Dashboard → Project Settings → API → Project API keys → `anon` / `public` key                                     | Safe to expose to the browser. Used by Supabase Auth.                                                                                                                                                                                                              |
